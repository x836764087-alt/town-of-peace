...
export const CHARACTERS: CharacterConfig[] = [
  {
    id: 'zhao-changhe', name: '赵长河', title: '里正', gender: '男', age: 54,
  ...
  {
    id: 'ma-xiuying', name: '马秀英', title: '社区后勤', gender: '女', age: 52,
  ...
  {
    id: 'lao-wang', name: '老王', title: '客栈老板', gender: '男', age: 52,
  ...
  },
  {
    ...
    wealth: 120,
    initialRelationships: { 'xiao-lin': 65, 'su-linger': 40 },
  },
  {
    ...
    wealth: 80,
    initialRelationships: { 'xiao-ye': 70, 'chen-xiaofei': 35 },
  },
  {
    id: 'chen-dajiang', name: '陈大江', title: '面摊主', gender: '男', age: 48,
  ...
  {
    id: 'chen-xiulan', name: '陈秀兰', title: '面摊老板娘', gender: '女', age: 45,
  ...
  },
  {
    ...
    initialBuilding: 'noodle_stall',
    wealth: 30,
    initialRelationships: { 'su-linger': 55, 'lin-meiqi': 30 },
  },
  {
    id: 'zhou-jianguo', name: '周建国', title: '塾师', gender: '男', age: 66,
  ...
  {
    id: 'wang-xiuzhi', name: '王秀芝', title: '接生婆', gender: '女', age: 63,
  ...
  },
  {
    ...
    initialBuilding: 'school',
    wealth: 60,
    initialRelationships: { 'chen-zhijie': 60, 'chen-xiaofei': 25 },
  },
  {
    id: 'zhang-dashan', name: '张大山', title: '铁匠', gender: '男', age: 46,
    ...
    wealth: 250,
    initialRelationships: { 'wang-cuihua': 50 },
  },
  {
    id: 'wang-cuihua', name: '王翠花', title: '种花人', gender: '女', age: 43,
    ...
    wealth: 60,
    initialRelationships: { 'zhang-dashan': 45 },
  },
  {
  ...
  },
  {
    ...
    wealth: 180,
    initialRelationships: { 'chen-zhijie': 70 },
  },
  {
    ...
    wealth: 40,
    initialRelationships: { 'chen-xiaofei': 60, 'xiao-ye': 30 },
  },
  {
    ...
    initialBuilding: 'town_hall',
    wealth: 80,
    initialRelationships: { 'bai-ruolan': 65, 'zhou-xiaoyue': 55 },
  },
  {
    ...
    wealth: 60,
    initialRelationships: { 'zhang-wu': 50 },
  },
];
